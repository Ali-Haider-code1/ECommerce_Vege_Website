  ...
  if (isset($_SESSION['email'])) {
    ...
    if ($result) {
      ...
      if ($row) {
        ...
        // Insert data into contactus table along with the user ID
        $insertQuery = "INSERT INTO contactus (user_id, name, email, message)
  ...
  <div class="container">
    ...
    <div class="row block-9">
      <div class="col-md-6 order-md-last d-flex">
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="bg-white p-5 contact-form">
